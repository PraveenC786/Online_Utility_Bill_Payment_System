# 📚 OnlineUtilityBillPayment_SpringBoot
...
A complete web-based **Online Utility Bill Payment** application built using
**Java, JDBC, and MySQL**, following the **MVC
architecture**.\
...
**Praveen**\
Java Full Stack Developer | Web Development
